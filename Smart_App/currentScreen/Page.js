...
const Page = ({ backgroundColor, iconName, title, headerTitle, heightTitle, weightTitle, ageBox, genderBox, raceBox }) => {
  ...
  return (
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
      ...
      >
        <Icon name={iconName} size={150} color="white" style={{position: 'relative',marginTop:80}} />
        <View style={{ marginTop: 16 }}>
          ...
          <Text style={{ fontSize: 24, fontWeight: 'bold', color: 'white', textAlign: 'center', paddingBottom: 50 }}>
            {title}
          </Text>
          {weightTitle !== "" ?
          <TextInput
